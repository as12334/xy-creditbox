 ...
 * @time 2018-07-09
 */
public class LotteryResultOpenNumberTask extends CommonTask<LotteryResultNumberVo> {

    public static final Log LOG = LogFactory.getLog(LotteryResultOpenNumberTask.class);
    ...
    public Object call() throws Exception {
        if(this.numberVo == null || this.numberVo._getSiteId() == null || this.numberVo.getResult() == null){
            ...
            this.numberVo.setErrMsg("商户开号失败,缺少参数");
            LOG.error("商户开号失败,原因:{0}",this.numberVo.getErrMsg());
