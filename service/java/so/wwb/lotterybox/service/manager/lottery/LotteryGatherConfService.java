package so.wwb.lotterybox.service.manager.lottery;

import org.soul.service.support.BaseService;
import so.wwb.lotterybox.data.manager.lottery.LotteryGatherConfMapper;
import so.wwb.lotterybox.iservice.manager.lottery.ILotteryGatherConfService;
import so.wwb.lotterybox.model.manager.lottery.po.LotteryGatherConf;
import so.wwb.lotterybox.model.manager.lottery.vo.LotteryGatherConfListVo;
import so.wwb.lotterybox.model.manager.lottery.vo.LotteryGatherConfVo;
