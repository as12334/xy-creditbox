 ...
 * @time 2018-07-09
 */
public class LotteryResultBatchAdjustTask extends CommonTask<LotteryResultNumberVo> {

    public static final Log LOG = LogFactory.getLog(LotteryResultBatchAdjustTask.class);
    ...
    public Object call() throws Exception {
        if(this.numberVo == null || this.numberVo._getSiteId() == null){
            ...
            this.numberVo.setErrMsg("商户批量调盘失败,缺少参数");
            LOG.error("商户批量调盘失败,原因:{0}",this.numberVo.getErrMsg());
        ...
        this.numberVo = lotteryResultNumberService.doBatchAdjust(this.numberVo);
