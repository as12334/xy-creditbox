...
<form name="resetPwdEditForm">
    <div class="modal-body">
        ...
        <div class="m-b-sm">账号：<span class="co-blue">${empty fn:substringBefore(command.result.username,'@')?command.result.username:fn:substringBefore(command.result.username,'@')}</span></div>
    ...
    <div class="modal-footer">
        <soul:button target="${root}/boss/account/merchant/updateMhPwd.html" post="getCurrentFormData" precall="validateForm" text="${views.common['confirm']}" opType="ajax" dataType="json" cssClass="btn btn-filter" callback="saveCallbak" tag="button"/>
        <soul:button cssClass="btn btn-outline btn-filter" target="closePage" text="取消" opType="function"/>
</div>
</form>
</body>
<%@ include file="/include/include.js.jsp" %>
<soul:import res="site/boss/account/company/ResetPwd"/>
</html>