...
<form name="resetPwdEditForm">
    ...
    <div class="modal-footer">
        <soul:button target="${root}/boss/account/merchant/updateMhPwd.html" post="getCurrentFormData" precall="validateForm" text="确认" opType="ajax" dataType="json" cssClass="btn btn-filter" callback="saveCallbak" tag="button"/>
