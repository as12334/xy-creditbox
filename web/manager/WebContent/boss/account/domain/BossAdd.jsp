...
<body>
    <form:form id="bossBossAddForm">
        ...
        <div class="modal-footer">
            <soul:button target="${root}/account/domain/addBossDomain.html" callback="saveCallbak" post="getCurrentFormData"  precall="validateForm" text=""   opType="ajax" dataType="json" cssClass="btn btn-filter _search" tag="button">${views.common['confirm']}</soul:button>
...
<soul:import res="site/boss/account/domain/BossEdit"/>
</html>
