...
<div class="row">
    <form:form id="shareHolderDomainForm" action="${root}/site/companiesSiteDetail/viewDomainCompanies.html?search.siteId=${getSiteId}&search.sysUserId=${command.search.sysUserId}"
               method="post">
        <div class="position-wrap clearfix">
            <span>股东</span><span>/</span><span>股东站点</span>
            <span>/</span><span>股东域名</span>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="m-b-xs clearfix">
            ...
            <div class="form-group clearfix pull-left col-md-1 col-sm-12 m-b-sm padding-r-none-sm">
                <div class="input-group date">
                        <soul:button target="${root}/account/domain/companiesCreate.html?search.siteId=${getSiteId}&search.sysUserId=${command.search.sysUserId}"
                                     opType="dialog" text="新增"
                                     cssClass="btn btn-info btn-addon" callback="callBackQuery" permission="domain:shareholder_create">
    ...
    <soul:import res="site/boss/site/companies/detail/ViewDomain"/>
</div>