...
<div class="table-responsive table-min-h">
    <table class="table table-striped table-hover dataTable m-b-sm" id="editable" aria-describedby="editable_info">
        ...
        <tr class="bg-gray">
            ...
            <th>
                <lb:select name="search.resolveStatus" listKey="code" listValue="trans" callback="query" cssClass="btn-group chosen-select-no-single" value="${command.search.resolveStatus}" list="${domainResolvestatus}"
                           prompt="全部状态"/>
            </th>
            <th>状态</th>
            <th>创建时间</th>
        ...
        <c:forEach items="${command.result}" var="p" varStatus="status">
            <tr class="gradeA ${status.index%2==0?'odd':'even'}">
                ...
                <td>
                    <shiro:hasPermission name="domain:shareholder_status">
                    <c:choose>
