                ...
                <tr class="tab-detail">
                    ...
                    <td>
                        <c:if test="${p.builtIn ne 'true'}">
                            <soul:button target="${root}/siteConfineArea/shareHolderEdit.html?search.id=${p.id}" permission="blacklist:black_edit"  size="open-dialog-50" text="编辑" cssClass="co-blue m-r-xs m-l-xs" opType="dialog" callback="callBackQuery" />
                        </c:if>
                    </td>
                </tr>
            </c:forEach>
