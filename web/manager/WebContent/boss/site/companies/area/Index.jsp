...
<form:form action="${root}/siteConfineArea/shareHolderConfineAreaList.html?search.siteId=${command.search.siteId}" method="post" id="shareHolderMainFrameArea">
    <div class="row">
        <div class="position-wrap clearfix">
            <span>站点</span><span>/</span><span>股东站点</span>
            <span>/</span><span>黑名单</span>
            <a href="/site/siteShareHolder/list.html" nav-target="mainFrame"
...
<soul:import res="site/boss/site/companies/area/Index"/>
