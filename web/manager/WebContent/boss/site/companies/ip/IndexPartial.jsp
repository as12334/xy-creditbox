...
<div class="createButton">
    <div class="float-left">
        <soul:button tag="button" target="${root}/siteConfineIp/shareHolderCreate.html?search.siteId=${command.search.siteId}"
                     text="新增" title="新增" opType="dialog"
                     cssClass="btn btn-info btn-addon" size="open-dialog-50"
                     callback="callBackQuery" permission="siteConfineIp:shareHolder_create">
    ...
    <div class="function-menu-show hide">
        <soul:button precall="confirmMessage" tag="button"
                     ...
                     target="${root}/siteConfineIp/shareHolderBatchDeleteArea.html"
                     post="getSelectIds" opType="ajax"
                     cssClass="btn btn-outline btn-filter"
                     callback="query" permission="siteConfineIp:shareHolder_delete">
