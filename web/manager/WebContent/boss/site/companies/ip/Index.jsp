...
<form:form action="${root}/siteConfineIp/shareHolderConfineIpList.html?search.siteId=${command.search.siteId}" method="post"
           id="shareHolderMainFrameIp">
    <div class="row">
    <lb:validateRule/>
        <lb:token/>
...
<soul:import res="site/boss/site/companies/ip/Index"/>
