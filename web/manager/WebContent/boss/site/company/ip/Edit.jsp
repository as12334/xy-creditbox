...
<form:form id="merchantSiteEditIpForm"  method="post">
    <lb:validateRule/>
        ...
        <div class="form-group clearfix line-hi34">
            ...
            <div class="input-group col-xs-8  line-hi34">
                <div class="input-group-btn" >
                    <lb:select name="result.type" list="${typeMap}" prompt="" value="${command.result.type}"
                               listValue="value" listKey="key"></lb:select>
                </div>
            </div>
        </div>
        <div class="form-group clearfix line-hi34">
...
<soul:import res="site/boss/site/company/ip/Edit"/>
</html>
