...
<form:form action="${root}/siteConfineIp/merchantSiteConfineIpList.html?search.siteId=${command.search.siteId}" method="post"
           id="merchantMainFrameIp">
    <div class="row">
    <lb:validateRule/>
...
<soul:import res="site/boss/site/company/ip/Index"/>
