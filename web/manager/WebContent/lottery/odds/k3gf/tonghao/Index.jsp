        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>二同号单选</span></th>
                        <c:set var="odd" value="${command.k3_danxuan_ertong}"/>
                            <td>
                        ...
                        <th><span>二同号复选</span></th>
                        <c:set var="odd" value="${command.k3_fuxuan_ertong}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                    ...
                    <tr>
                        <th><span>三同号单选</span></th>
                        <c:set var="odd" value="${command.k3_danxuan_santong}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                        ...
                        <th><span>三同号通选</span></th>
                        <c:set var="odd" value="${command.k3_tongxuan_santong}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
