                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <div class="input-group content-width-limit-10">
                                        <input type="hidden" value="${command['810'].id}" name="lotteryOdds[14].id">
                                        <input type="hidden" value="${command['810'].code}" name="lotteryOdds[14].code">
                                        <input type="hidden" value="${command['810'].betCode}" name="lotteryOdds[14].betCode">
                                        <input type="hidden" value="${command['810'].siteId}" name="lotteryOdds[14].siteId">
                                        <input type="hidden" value="${command['810'].betNum}" name="lotteryOdds[14].betNum">
                                        <input type="text" class="form-control input-sm" placeholder="<=${command['810'].oddLimit}" data-limit="${command['810'].oddLimit}" data-value="${command['810'].odd}" name="lotteryOdds[14].odd" value="${command['810'].odd}">
                                    </div>
                                </div>
                            </td>
                        </tr>
