            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tr>
                        ...
                        <c:set var="odd" value="${command.pl3_erxing_zuxuan_qefs}"/>
                            <td>
                        ...
                        <c:set var="odd" value="${command.pl3_erxing_zuxuan_qeds}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                        ...
                        <th><span>后二组选复式</span></th>
                        <c:set var="odd" value="${command.pl3_erxing_zuxuan_hefs}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                    ...
                    <tr>
                        <th><span>后二组选单式</span></th>
                        <c:set var="odd" value="${command.pl3_erxing_zuxuan_heds}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
