                    ...
                    <c:forEach begin="0" end="27" var="i">
                        ...
                        <td>
                            <div class="input-group content-width-limit-10">
                                ...
                                <input type="text" class="form-control input-sm" name="lotteryOdds[${i}].odd" placeholder="<=${odd.oddLimit}" data-limit="${command[num].oddLimit}" data-value="${command[num].odd}" value="${command[num].odd}">
                            </div>
                        </td>
                        <c:if test="${i%5==4}">
                            </tr>
