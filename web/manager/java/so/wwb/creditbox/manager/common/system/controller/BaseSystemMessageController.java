package so.wwb.creditbox.manager.common.system.controller;
...
import so.wwb.creditbox.iservice.manager.message.ISystemMessageService;
import so.wwb.creditbox.manager.common.system.form.SystemMessageForm;
import so.wwb.creditbox.manager.common.system.form.SystemMessageSearchForm;
import so.wwb.creditbox.model.enums.base.SubSysCodeEnum;
import so.wwb.creditbox.model.enums.message.SystemMessageSendObjectEnum;
import so.wwb.creditbox.model.enums.message.SystemMessageSendTypeEnum;
