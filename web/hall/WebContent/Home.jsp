...
<head>
    ...
    <%--<link rel="stylesheet" href="./聚發_files/base.css">--%>
    <%--<link rel="stylesheet" href="./聚發_files/global.css">--%>
    <%--<link id="skin" rel="stylesheet" href="./聚發_files/skin.css">--%>
    ...
    <%--<script src="./聚發_files/sea.js.下载" type="text/javascript"></script>--%>
    <%--<script src="./聚發_files/seajs-css.js.下载" type="text/javascript"></script>--%>
    <%--<script src="./聚發_files/config.js.下载" type="text/javascript"></script>--%>
        ...
        <div class="user_info">
            <p class="user_name">as12334
                <span id="skinChange"><a class="skin_btn" href="javascript:;">換膚</a>
					<em id="skinBox"><a data-skin="Yellow" class="user_skin skin_yellow" href="javascript:;"><i></i>栀子黄</a><a data-skin="Blue" class="user_skin skin_blue" href="javascript:;"><i></i>天空藍</a><a data-skin="Red" class="user_skin skin_red on" href="javascript:;"><i></i>寶石紅</a><a data-skin="Green" class="user_skin skin_green" href="javascript:;"><i></i>翡翠綠</a></em>
				</span>
                <b id="soundSwitch" title="聲音開關" class="lbOn"></b>
            </p>
            <p><span class="nameType">(快)</span>額度：<span id="creditSpan">0</span><em>|</em> <span class="nameType">(快)</span>可用：<span id="usableCreditSpan">0</span></p>
        </div>
        <div class="user_select">
            <a id="user_select_btn" href="javascript:void(0)"></a>
            <div class="user_select_item" style="width: 176px;"><span class="user_select_itme_left"><h3>快彩</h3><p>盘　　口：A</p><p>信用額度：0</p><p>可用金額：0</p><p></p></span></div>
        </div>
    </div>
</div>
<div class="top_menu base-clear">
    <div class="menu">
        ...
        <div>
            <ul id="menuList"><li><a data-id="0" data-type="2" data-url="L_KL10" href="javascript:void(0)">廣東快樂十分</a></li><li><a data-id="1" data-type="2" data-url="L_CQSC" href="javascript:void(0)">重慶時時彩</a></li><li><a data-id="2" data-type="2" data-url="L_PK10" href="javascript:void(0)">北京賽車(PK10)</a></li><li><a data-id="6" data-type="2" data-url="L_K8SC" href="javascript:void(0)">幸運飛艇(3分鍾)</a></li><li><a data-id="9" data-type="2" data-url="L_XYFT5" href="javascript:void(0)">幸運飛艇(5分鍾)</a></li><li><a data-id="10" data-type="2" data-url="L_JSCAR" href="javascript:void(0)">極速賽車</a></li><li><a data-id="11" data-type="2" data-url="L_SPEED5" href="javascript:void(0)">極速時時彩</a></li><li><a data-id="12" data-type="2" data-url="L_JSPK10" href="javascript:void(0)">極速PK10(5分鍾)</a></li><li><a data-id="13" data-type="2" data-url="L_JSCQSC" href="javascript:void(0)">極速時時彩(5分鐘)</a></li></ul>
        </div>
    </div>
    <div class="nav base-clear">
        ...
        <a data-action="" href="http://mem1.vnfbsg517.hlbrhuanyou.com:88/Quit.aspx" style="border-right:none;"><i class="icon7"></i><span>安全退出</span></a>
    </div>
</div>
<iframe id="mainIframe" name="mainIframe" src="./聚發_files/index.html" width="100%" height="519" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" style="height: 873px;"></iframe>
<div class="notice">
    <div class="notice_box">
        <div class="notice_p base-clear">
            <p>
                <marquee id="noticeLink" behavior="scroll" scrollamount="2" direction="left" onmouseout="this.setAttribute(&#39;scrollamount&#39;, 2, 0);" onmouseover="this.setAttribute(&#39;scrollamount&#39;, 0, 0);"><a data-action="" href="javascript:;"><span>聚发原网址911yg.com改为847e.com 安全码656829备用网址863126.com  请各级代理会员知悉!!!</span><span>2019/10/20 0:00:00</span></a></marquee>
            </p>
...
<script>
    ...
    // 72
    // var maxLen = 45;
    var configLm = {"72_0": {"minLen":2,"maxLen":28 },"73_0": {"minLen":2,"maxLen":45 },"74_0": {"minLen":2,"maxLen":28 },"75_0": {"minLen":3,"maxLen":20 },"76_0": {"minLen":3,"maxLen":45 },"77_0": {"minLen":3,"maxLen":20 },"78_0": {"minLen":4,"maxLen":70 },"79_0": {"minLen":5,"maxLen":56 },"72_3": {"minLen":2,"maxLen":28 },"73_3": {"minLen":2,"maxLen":45 },"74_3": {"minLen":2,"maxLen":28 },"75_3": {"minLen":3,"maxLen":20 },"78_3": {"minLen":4,"maxLen":70 },"79_3": {"minLen":5,"maxLen":56 },"71014_7": {"minLen":3,"maxLen":56 },"72_14": {"minLen":2,"maxLen":28 },"73_14": {"minLen":2,"maxLen":45 },"74_14": {"minLen":2,"maxLen":28 },"75_14": {"minLen":3,"maxLen":20 },"76_14": {"minLen":3,"maxLen":45 },"77_14": {"minLen":3,"maxLen":20 },"78_14": {"minLen":4,"maxLen":70 },"79_14": {"minLen":5,"maxLen":56 },"91016_100": {"minLen":3,"maxLen":56 },"91017_100": {"minLen":3,"maxLen":56 },"91018_100": {"minLen":2,"maxLen":28 },"91019_100": {"minLen":2,"maxLen":28 },"91020_100": {"minLen":2,"maxLen":28 },"91040_100": {"minLen":4,"maxLen":70 },"91037_100": {"minLen":5,"maxLen":56 },"91047_100": {"minLen":6,"maxLen":28 },"91048_100": {"minLen":7,"maxLen":8 },"91049_100": {"minLen":8,"maxLen":1 },"91050_100": {"minLen":9,"maxLen":1 },"91051_100": {"minLen":10,"maxLen":1 },"91030_100": {"minLen":6,"maxLen":1 },"91031_100": {"minLen":2,"maxLen":28 },"91032_100": {"minLen":3,"maxLen":56 },"91033_100": {"minLen":4,"maxLen":70 },"91034_100": {"minLen":2,"maxLen":28 },"91035_100": {"minLen":3,"maxLen":56 },"91036_100": {"minLen":4,"maxLen":70 }};
