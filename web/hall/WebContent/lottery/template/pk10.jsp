    ...
    <div class="top_info_box base-clear">
        <div class="game_name_wrap base-clear">
            <div class="game_pic">
                ...
                <a href="http://www.luckyairship.com/" target="_blank"><img id="game_logo" src="" alt=""></a>
            </div>
            <div class="game_name">
                <h5><a href="http://www.luckyairship.com/" target="_blank" title="官網"><span id="game_big_name"></span></a> <span>-</span> <em id="game_small_name"></em></h5>
...
<%--<script src="../Scripts/kc_script.js" type="text/javascript"></script>--%>

<script>

    var JeuValidate = '11250234537297';
    var GameName = '';
