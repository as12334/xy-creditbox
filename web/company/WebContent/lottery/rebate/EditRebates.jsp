                            ...
                            <table class="t_list">
                                ...
                                <tr style="" class="">
                                    ...
                                    <td style=""><input type="text" name="tm_pk_b" id="tm_pk_b" data-b=""
                                                        class="text zk plNumber w80" value="0"></td>
                                    <td style=""><input type="text" name="tm_pk_c" data-c="" id="tm_pk_c"
                                                        class="text zk plNumber w80" value="102"></td>
                                                    ...
                                                    <table class="middle-table bor-top">
                                                        ...
                                                        <c:forEach var="map1" items="${map.value}" begin="0" end="${ind - 1}">
                                                            <tr data-sid="1" data-sort="1" class="">
                                                                ...
                                                                <td><input type="text" data-d="" class="text-input sw70" data-number="" maxlength="3" data-maxvalue="100" data-minvalue="0" data-sort="1" value="0"></td>
                                                                <td><input type="text" data-e="" class="text-input sw70" data-number="" maxlength="7" data-maxvalue="500000" data-minvalue="0" data-sort="1" value="500000"></td>
                                                                <td><input type="text" data-f="" class="text-input sw70" data-number="" maxlength="7" data-maxvalue="500000" data-minvalue="0" data-sort="1" value="500000"></td>
                                                                <td><input type="text" data-a="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="102" data-minvalue="0" data-sort="1" value="102"></td>
                                                                <td><input type="text" data-b="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="0" data-minvalue="0" data-sort="1" value="0"></td>
                                                                <td><input type="text" data-c="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="102" data-minvalue="0" data-sort="1" value="102"></td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
