                        ...
                        <div id="load-userrebate-game-kc">
                            ...
                            <table class="t_list">
                                ...
                                <tr style="" class="">
                                    ...
                                    <td style=""><label class="lBg1"></label><input type="text" name="tm_pk_a" id="tm_pk_a" data-a="" class="text zk plNumber w80" value="102"></td>
                                    <td style=""><input type="text" name="tm_pk_b" id="tm_pk_b" data-b="" class="text zk plNumber w80" value="0"></td>
                                    <td style=""><input type="text" name="tm_pk_c" data-c="" id="tm_pk_c" class="text zk plNumber w80" value="102"></td>
                                    ...
                                    <td><input type="text" name="tm_single_min_amount" data-d="" id="tm_single_min_amount" class="text zk onlyNum w80" value="0"></td>
                                ...
                                <tr style="" class="">
                                    <td>兩面類(單雙、大小、龍虎 …)</td>
                                    <td style=""><label class="lBg2"></label><input type="text" name="lmp_pk_a" id="lmp_pk_a" data-a="" class="text zk plNumber w80"  value="102"></td>
                                    <td style=""><input type="text" name="lmp_pk_b" id="lmp_pk_b" data-b="" class="text zk plNumber w80" value="0"></td>
                                    <td style=""><input type="text" name="lmp_pk_c" data-c="" id="lmp_pk_c" class="text zk plNumber w80" value="102"></td>
                                    ...
                                    <td><input type="text" name="lmp_single_min_amount" data-d="" id="lmp_single_min_amount" class="text zk onlyNum w80" value="0"></td>
                                ...
                                <tr style="" class="">
                                    <td>連碼類(任選二、任選三 …)</td>
                                    <td style=""><label class="lBg3"></label><input type="text" name="lm_pk_a" id="lm_pk_a" data-a="" class="text zk plNumber w80" value="102"></td>
                                    <td style=""><input type="text" name="lm_pk_b" id="lm_pk_b" data-b="" class="text zk plNumber w80" value="102"></td>
                                    <td style=""><input type="text" name="lm_pk_c" data-c="" id="lm_pk_c" class="text zk plNumber w80" value="102"></td>
                                    ...
                                    <td><input type="text" name="lm_single_min_amount" data-d="" id="lm_single_min_amount" class="text zk onlyNum w80" value="0"></td>
                                            ...
                                            <div data-close="0" data-index="klc" class="acion">
                                                ...
                                                <div style="float:left;width:49.9%">
                                                    <table class="middle-table bor-top">
                                                        ...
                                                        <c:forEach var="map1" items="${map.value}" begin="0" end="${ind - 1}">
                                                            <tr data-sid="${map1.value.sortType}" data-sort="1" class="">
                                                                <td class="bc"><label class="lBg1"></label>${map1.key}</td>
                                                                <td><input type="text" data-d="" class="text-input sw70" data-number="" maxlength="3" data-maxvalue="100" data-minvalue="0" data-sort="1" value="${map1.value.minBet}"></td>
                                                                <td><input type="text" data-e="" class="text-input sw70" data-number="" maxlength="7" data-maxvalue="500000" data-minvalue="0" data-sort="1" value="${map1.value.maxBet}"></td>
                                                                <td><input type="text" data-f="" class="text-input sw70" data-number="" maxlength="7" data-maxvalue="500000" data-minvalue="0" data-sort="1" value="${map1.value.maxExpectBet}"></td>
                                                                <td><input type="text" data-a="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="102" data-minvalue="0" data-sort="1" value="${map1.value.rebateA}"></td>
                                                                <td><input type="text" data-b="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="0" data-minvalue="0" data-sort="1" value="${map1.value.rebateB}"></td>
                                                                <td><input type="text" data-c="" class="text-input sw50" data-numbertodouble="" maxlength="5" data-maxvalue="102" data-minvalue="0" data-sort="1" value="${map1.value.rebateC}"></td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
