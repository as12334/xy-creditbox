                    ...
                    <div id="1571103618814">
                        <table class="middle-table" id="add-user">
                            ...
                            <tr>
                                ...
                                <td class="txt-left"><input type="text" name="result.password" autocomplete="off"
                                                            maxlength="20"
                            ...
                            <tr>
                                ...
                                <td class="txt-left"><input type="text" name="result.credits" autocomplete="off"
                                                            maxlength="9"
                            ...
                            <tr>
                                ...
                                <td class="txt-left"><label class="label-box"><input type="radio"
                                                                                     name="result.manualAutoShipments"
                                                                                     checked="checked"
                                                                                     value="1">啟用</label>
                            ...
                            <tr>
                                ...
                                <td class="txt-left">
                                    ...
                                    <label class="label-box"><input type="radio" name="result.general" checked="checked"
                                                                    value="0">關閉</label></td>
                            </tr>
                            <tr>
                                ...
                                <td class="txt-left"><input type="text" name="result.superiorOccupy" autocomplete="off"
                                                            maxlength="3"
                            ...
                            <tr>
                                    ...
                                    <%--<td class="txt-left">--%>
                                    <%--<label class="label-box"><soul:button  cssClass="btn btn-filter btn-lg" text="保存" opType="ajax" dataType="json"--%>
                                    <%--target="${root}/sysUserExtend/saveManagerUser.html" post="getCurrentFormData" callback="saveCallbakUser"/></label>--%>
