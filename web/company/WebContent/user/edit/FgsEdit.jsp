                    ...
                    <tbody><tr id="six" class="tabBox">
                        <td><table class="t_list" border="0" cellspacing="0" cellpadding="0">
                            <tbody><tr>
                                ...
                                <td align="left">&nbsp;<input type="text" data-max="0" name="userCredit_six" id="userCredit_six" class="text w130 zfNumber toRMB"><span class="toRMBspan"></span>
                                    上級餘額:
                            ...
                            <tr>
                                ...
                                <td align="left">&nbsp;<input type="text" data-max="0" name="userRate_six" id="userRate_six" class="text zfNumber">
                                    % 　最高可設占成
                    ...
                    <tr id="kc" class="tabBox tabBoxOn" style="display: table-row;">
                        <td><table class="t_list" border="0" cellspacing="0" cellpadding="0">
                            <tbody><tr>
                                ...
                                <td align="left">&nbsp;<input type="text" data-max="0" name="userCredit_kc" id="userCredit_kc" class="text w130 zfNumber toRMB"><span class="toRMBspan"></span>
                                    上級餘額:
                            ...
                            <tr>
                                ...
                                <td align="left">&nbsp;<input type="text" data-max="0" name="userRate_kc" id="userRate_kc" class="text zfNumber">
                                    % 　最高可設占成
                            ...
                            <tr>
                                ...
                                <td align="left"><label class="topLabel"><input type="radio" id="allowmaxrate_kc" name="allowmaxrate_kc" value="0" checked="checked">
                                    <span>
											占餘成數下綫任占
										</span>
                                </label>
