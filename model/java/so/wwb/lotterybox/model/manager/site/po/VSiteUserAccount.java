 ...
 */
//region your codes 1
public class VSiteUserAccount implements IEntity<Integer> {
//endregion your codes 1

	//region your codes 3
	private static final long serialVersionUID = 5633678166174333020L;
	...
	//region constuctors
	public VSiteUserAccount(){
	}

	public VSiteUserAccount(Integer id){
		this.id = id;
	}
	//endregion
