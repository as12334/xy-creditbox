...
import so.wwb.lotterybox.model.enums.notice.ContactWayStatus;
import so.wwb.lotterybox.model.enums.notice.ContactWayType;
import so.wwb.lotterybox.model.manager.user.po.VSubAccount;
import so.wwb.lotterybox.model.manager.user.so.VSubAccountSo;
