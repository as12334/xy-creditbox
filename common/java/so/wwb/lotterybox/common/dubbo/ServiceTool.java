...
import so.wwb.lotterybox.iservice.company.lottery.*;
import so.wwb.lotterybox.iservice.company.site.ISiteSysParamService;
import so.wwb.lotterybox.iservice.company.user.IVUserDetailService;
import so.wwb.lotterybox.iservice.manager.common.*;
import so.wwb.lotterybox.iservice.manager.lottery.ILotteryHandicapService;
...
import so.wwb.lotterybox.iservice.manager.lottery.ILotteryTypeService;
import so.wwb.lotterybox.iservice.manager.message.ISystemAnnouncementService;
import so.wwb.lotterybox.iservice.manager.sys.*;
